/*var einkaufsliste = ["Apfel", "Banane", "Milch", "Fleisch"];
einkaufsliste.forEach(mySchleife);

function mySchleife(wert, index) {
    document.body.innerHTML += index + ". " + wert + "<br>";
} */
...
function add() {
    ...
    var preis = parseInt(inputPreis.value); //simdi stringi sayiya cevirdik!
